...
#         attention_mask: (batch_size, seq_len) tensor indicating valid positions
#     """
#     state_mask = np.zeros(traj_length)
#     action_mask = np.zeros(traj_length)
    
#     if attention_mask is not None:
#         # For batched operation, we'll create a base mask and modify per sample later
#         # This function creates the template mask for the full sequence length
#         # The actual masking will be applied considering attention_mask in the loss function
        
#         # Use last 20% of the maximum trajectory length as baseline
#         goal_start_idx = 55
#         state_mask[goal_start_idx:] = 1
#         action_mask[goal_start_idx:] = 1
#     else:
#         # Legacy mode for single trajectories
#         goal_start_idx = 54
#         state_mask[goal_start_idx:] = 1
#         action_mask[goal_start_idx:] = 1
...
#     if attention_mask is not None:
#         # For batched operation with variable lengths
#         # Use first 30% of maximum trajectory length as baseline
#         id_end_idx = max(1, int(traj_length * 0.3))
#         state_mask[0:id_end_idx] = 1
#         action_mask[0:id_end_idx] = 1
#     else:
#         # Legacy mode for single trajectories
#         id_end_idx = max(1, int(traj_length * 0.3))  # First 30% of trajectory
#         state_mask[0:id_end_idx] = 1
#         action_mask[0:id_end_idx] = 1
...
#     if attention_mask is not None:
#         # For batched operation with variable lengths
#         # Use middle portion of maximum trajectory length
