    ...
    def forward_loss(
        ...
        for key in targets.keys():
            ...
            if discrete_map[key]:
                ...
                # values_weights = [
                #             0.94613575, 0.99238462, 0.99989593, 0.99966516, 0.97208597, 0.9879095,
                #             0.99972398, 0.9999638, 0.99873303, 0.9971086, 0.99155204, 0.9998371,
                #             0.9999638, 0.99878733, 0.99782805, 1.0, 1.0, 0.99937557,
                #             0.99927149, 0.99456109, 0.99448416, 0.99942986, 0.99988688, 0.9999638,
                #             0.99982353, 0.9999457, 0.99367873, 0.99949321, 0.9999819, 1.0,
                #             0.99978281, 0.99976923, 1.0, 1.0, 0.99958371, 0.99843891,
                #             0.99981448, 0.99924887, 0.99966063, 0.99798643, 0.9999819, 0.9999095,
                #             0.99966063, 0.9999819, 0.99917195, 0.89477376, 0.25076471
                #         ]
                values_weights = [18.565188172043012,
                                131.31313131313132,
                                9608.695652173914,
                                2986.4864864864867,
                                35.82428270384179,
                ...
                # values_weights = [1-item for item in values_weights]

                class_weights = torch.tensor(values_weights, device=pred.device)
                print("Class weights for focal loss: ", class_weights)
                ...
                focal_loss = ((1 - pt) ** gamma * ce_loss).mean(dim=-1, keepdim=True)
                raw_loss = focal_loss
