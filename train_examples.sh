...
# Running MTM
# ***************************
#$workspace_dir="/data/home/umang/Trajectory_project/mtm"
...
python research/mtm/train.py +exp_exorl=exorl_cont dataset.env_name="point_mass_maze_reach_top_left" dataset.replay_buffer_dir="/data/home/umang/Trajectory_project/mtm/research/exorl/datasets/"
